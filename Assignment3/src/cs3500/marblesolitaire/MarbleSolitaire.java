...
/**
 * This class represents the main class which allows the user to interact with the
 * marble solitaire game.
 */
public final class MarbleSolitaire {
  /**
   * Represents the entry point for the program. It takes inputs as command-line
   * arguments (available through the argument args).
   *
